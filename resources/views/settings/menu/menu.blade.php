        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Create Menu</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-12 parent">
                            <div class="form-group">
                                <label for="name" class="col-form-label">Name Menu {{ dot() }}</label>
                                <input class="form-control required" type="text" placeholder="Masukan nama menu"
                                    id="name" name="name">
                        ...
                        <div class="col-sm-12 parent">
                            <div class="form-group">
                                <label for="group_menu_id" class="form-label">Group Menu {{ dot() }}</label>
                                <select id="group_menu_id" name="group_menu_id" class="select2 required form-control">
                                    <option value="">Pilih Group</option>
                                    @foreach (\App\Models\GroupMenu::where('status', true)->get() as $item)
                        ...
                        <div class="col-sm-12 parent">
                            <div class="form-group">
                                <label for="type" class="form-label">Type Menu {{ dot() }}</label>
                                <select id="type" name="type" class="select2 required form-control">
                                    <option value="">Pilih Jenis Menu</option>
                                    <option value="Menu">Menu</option>
                                    <option value="Non Menu">Non Menu</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12 parent">
