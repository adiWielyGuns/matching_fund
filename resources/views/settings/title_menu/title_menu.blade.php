    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#datatable-buttons').DataTable({
                ...
                ajax: {
                    url: "{{ route('datatable-title-menu') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    }
                },
        ...
        function gantiStatus(param, id) {
            $.ajax({
                url: '{{ route('ganti-status-title-menu') }}',
                data: {
                    id,
                    param
                },
