            ...
            <div class="modal-content">
                ...
                <form class="modal-body" id="form-data" onkeydown="return event.key != 'Enter';">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="name" class="col-form-label">No Rek {{ dot() }}</label>
                                <input class="form-control required" type="text" placeholder="Masukan no rekening"
                                    id="no_rekening" name="no_rekening">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="name" class="col-form-label">Bank {{ dot() }}</label>
                                <input class="form-control required" type="text" placeholder="Masukan bank"
                                    id="bank" name="bank">
                            </div>
                        </div>
                        <div class="col-sm-12">
        ...
        function edit(id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var url = data.data.bukti_transfer;
                    var imagenUrl = url;
