...
class GalleryController extends Controller
{
        ...
        return DB::transaction(function () use ($req) {
            ...
            if ($id == '' or $id == null) {
                ...
                $validator = Validator::make(
                    ...
                    [
                        'image'       => 'required',
                        'slug'       => 'unique:galleries' . ($req->id == null ? '' : ",slug,$req->id"),
                    ],
                    [
                ...
                $blogDetails = [
                    'id' => $this->galleryRepository->getIdGallery(),
                ...
                return response()->json(
                    [
                        ...
                        'data' => $this->galleryRepository->createGallery($blogDetails)
                    ],
                ...
                $validator = Validator::make(
                    $input,
                    [
                        'slug'       => 'unique:galleries' . ($id == null ? '' : ",slug,$id"),
                    ],
                    [
                ...
                if ($file != null) {
                    ...
                    $foto = $this->galleryRepository->getGalleryById($id)->image;
                }
                ...
                return response()->json(
                    [
                        ...
                        'data' => $this->galleryRepository->updateGallery($id, $blogDetails)
                    ],
                    Response::HTTP_CREATED
                );
            }
    ...
    public function edit(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => $this->galleryRepository->getGalleryById($id),
    ...
    public function gantiStatus(Request $req): JsonResponse
    {
        ...
        return response()->json([
            'data' => $this->galleryRepository->updateGallery($id, $roleDetails),
            'message' => 'Berhasil merubah status data',
        ]);
    }
