...
{
    private TitleMenuRepositoryInterface $titleMenuRepository;

    public function __construct(TitleMenuRepositoryInterface $titleMenuRepository)
    {
        $this->titleMenuRepository = $titleMenuRepository;
    }

    public function index()
    {

        return view('settings/title_menu/title_menu');
    }
    ...
    public function store(Request $req): JsonResponse
    {
        ...
        return DB::transaction(function () use ($req) {
            ...
            if ($orderId == '' or $orderId == null) {
                $titleMenuDetails = [
                    'id' => $this->titleMenuRepository->getIdTitleMenu(),
                ...
                return response()->json(
                    [
                        ...
                        'data' => $this->titleMenuRepository->createTitleMenu($titleMenuDetails)
                    ],
                ...
                return response()->json(
                    [
                        ...
                        'data' => $this->titleMenuRepository->updateTitleMenu($orderId, $titleMenuDetails)
                    ],
                    Response::HTTP_CREATED
                );
            }
    ...
    public function edit(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => $this->titleMenuRepository->getTitleMenuById($orderId),
    ...
    public function destroy(Request $request): JsonResponse
    {
        ...
        $this->titleMenuRepository->deleteTitleMenu($orderId);
