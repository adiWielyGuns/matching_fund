...
{
    private GroupMenuRepositoryInterface $groupMenuRepository;

    public function __construct(GroupMenuRepositoryInterface $groupMenuRepository)
    {
    ...
    public function index()
    {
        ...
        return view('settings/group_menu/group_menu');
    }
    ...
    public function store(Request $req): JsonResponse
    {
        ...
        return DB::transaction(function () use ($req) {
            ...
            if ($orderId == '' or $orderId == null) {
                $groupMenuDetails = [
                    'id' => $this->groupMenuRepository->getIdGroupMenu(),
                    'icon' => $req->icon,
                    'name' => convertSlug($req->name, 'Capital'),
                    'title_menu_id' => $req->title_menu_id,
                    'slug' => $req->slug,
                    'type' => $req->type,
                    'created_by' => me(),
                    'updated_by' => me(),
                ...
                return response()->json(
                    [
                        ...
                        'data' => $this->groupMenuRepository->createGroupMenu($groupMenuDetails)
                    ],
                ...
                return response()->json(
                    [
                        ...
                        'data' => $this->groupMenuRepository->updateGroupMenu($orderId, $groupMenuDetails)
                    ],
                    Response::HTTP_CREATED
                );
            }
    ...
    public function edit(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => $this->groupMenuRepository->getGroupMenuById($orderId),
    ...
    public function destroy(Request $request): JsonResponse
    {
        ...
        $this->groupMenuRepository->deleteGroupMenu($orderId);
